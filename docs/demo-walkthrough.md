...
| 1.8 Refresh dynamic tables | `snow sql -c DEVACC --role DEV_HR_DEVELOPER --warehouse HR_DEV_WH -q "ALTER DYNAMIC TABLE WIP_2_HR_CORE_DB.DM.D_EMPLOYEE_CURRENT REFRESH; ALTER DYNAMIC TABLE WIP_2_HR_CORE_DB.DM.D_DEPARTMENT_CURRENT REFRESH; ALTER DYNAMIC TABLE WIP_2_HR_CORE_DB.DM.D_JOB_CURRENT REFRESH; ALTER DYNAMIC TABLE WIP_2_HR_CORE_DB.DM.F_EMPLOYEE_JOB_HISTORY REFRESH; ALTER DYNAMIC TABLE WIP_2_HR_CORE_DB.DM.F_EMPLOYEE_COMP_HISTORY REFRESH;"` | Each returns insertedRows > 0 |
