...
-- ETL role: clone management for CI/CD pipelines
GRANT USAGE ON DATABASE ADMIN_DB TO ROLE {{ env }}_{{ domain.name }}_ETL;
GRANT USAGE ON SCHEMA ADMIN_DB.DEPLOY TO ROLE {{ env }}_{{ domain.name }}_ETL;
GRANT USAGE ON PROCEDURE ADMIN_DB.DEPLOY.DEPLOY_CLONE(VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR) TO ROLE {{ env }}_{{ domain.name }}_ETL;
GRANT USAGE ON PROCEDURE ADMIN_DB.DEPLOY._PROVISION_CLONE(VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR) TO ROLE {{ env }}_{{ domain.name }}_ETL;
GRANT USAGE ON PROCEDURE ADMIN_DB.DEPLOY.DROP_CLONE(VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR) TO ROLE {{ env }}_{{ domain.name }}_ETL;
GRANT USAGE ON PROCEDURE ADMIN_DB.DEPLOY._DROP_CLONE(VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR) TO ROLE {{ env }}_{{ domain.name }}_ETL;
